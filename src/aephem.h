...
struct ae_saturn_components_t {
  double n_disc;            //!< Number of pixels looking on the disc.
  //! Number of pixels looking on-disc through each of the rings.
  double *n_ring_disc;
  //! Number of pixels looking off-disc through each of the rings.
  double *n_ring_back;
  double *exp_tau;          //!< For recording the opacity of the rings.
  double cos_ring_inc;      //!< Cosine of the ring inclination.
};
