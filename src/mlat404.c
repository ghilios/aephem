//! \file mlat404.c
//! Ephemeris for the moon.  These are with respect to the mean ecliptic
//! and equinox of date.  See main documentation page for details.
//==============================================================================
...
// See mlr404.c for test summary table.
